 ...
 *
 * @param Auto Fade
 * @desc 메시지 창이 활성화되면 hud에서 숨깁니다. Oculta na hud quando a janela de messagem estiver ativada.
 * @default true
 * @type boolean
 * @on Window Message
 * @off Always Visible 
 ...
 * @desc 게이지와 면 위에 두 번째 레이아웃을 표시합니다. Apresentar o segundo layout acima dos medidores e face.
 * @default false
 * @type boolean
 * @on Show
 * @off Hide
 ...
 *
 * @param Face Visible
 * @desc 얼굴 이미지를 표시합니다. Apresentar a imagem da face.
 * @default true
 * @type boolean
 * @on Show
 * @off Hide
 ...
 *
 * @param Face Priority
 * @desc 얼굴 우선 순위. (낮음 0 - 높음 1) Prioridade da Face. (0 Low - 1 High)
 * @default 1
 * @type select
 ...
 *
 * @param Name Visible
 * @desc 캐릭터의 이름을 표시합니다. Apresentar o nome do personagem.
 * @default true
 * @type boolean
 * @on Show
 * @off Hide
 ...
 * @desc 게이지에서 그라디언트 애니메이션을 활성화합니다. Ativar animação de gradiente no medidor.
