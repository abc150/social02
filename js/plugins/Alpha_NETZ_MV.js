/*:
 * @plugindesc (v.0.5)[PRO] Multiplayer for RPG Maker
...
Window_NetworkGameMenu = class Window_NetworkGameMenu extends Window_Command {
  ...
  makeCommandList() {
    this.addCommand("방 만들기", "createRoom");
    this.addCommand("방 참여하기", "joinRoom");
    this.addCommand("방 무작위 접속하기", "joinRandRoom");
    this.addCommand("설정하기", "settings");
  }
