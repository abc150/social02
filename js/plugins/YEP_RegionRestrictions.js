 ...
 * @desc 이 지역 ID는 플레이어의 입장을 제한합니다.
 * To use multiple regions, separate them by spaces.
 * @default 0
 *
 * @param Event Restrict
 * @desc 이 지역 ID는 모든 이벤트의 입장을 제한합니다.
 * To use multiple regions, separate them by spaces.
 * @default 0
 *
 * @param All Restrict
 * @desc 이 지역 ID는 플레이어와 이벤트를 제한합니다.
 * To use multiple regions, separate them by spaces.
 * @default 0
 *
 * @param Player Allow
 * @desc 이 지역 ID는 항상 플레이어의 통과 가능성을 허용합니다.
 * To use multiple regions, separate them by spaces.
 * @default 0
 *
 * @param Event Allow
 * @desc 이 지역 ID는 항상 이벤트 통과 가능성을 허용합니다.
 * To use multiple regions, separate them by spaces.
 * @default 0
 *
 * @param All Allow
 * @desc 이 지역 ID는 항상 두 가지 통과 가능성을 모두 허용합니다.
 * To use multiple regions, separate them by spaces.
 * @default 0
 *
 * @help
